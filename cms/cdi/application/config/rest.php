...
|
*/
$config['auth_override_class_method']['graphic']['getImage'] = 'none';
$config['auth_override_class_method']['file']['upload'] = 'none';
$config['auth_override_class_method']['file']['delete'] = 'none';
// $config['auth_override_class_method']['login']['index'] = 'none';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
$config['rest_valid_logins'] = array(
	'admin'		=> 'geheim',
	'apitest' 	=> 'apitest',
	'system'	=> '2yJrVHzdocXBg9avF4iMfmK7W36PvXBg9au'
	);
...
|
*/
// $config['rest_database_group'] 	= 'local'; // defined in main config
...
|
*/
$config['rest_keys_table'] = 'cdi_key';
...
|
*/
$config['rest_key_name'] = 'call_token';
...
|
*/
$config['rest_logs_table'] = 'cdi_log';
