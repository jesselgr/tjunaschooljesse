...
function debug_page()
{
	$CI  =& get_instance();
//	var_dump($CI);
	// debug setting for development, you know you love it //
	if($CI->session->userdata('debug'))$CI->parser->parse('static/debug'.'.tpl');
	if($CI->config->item('debug_button')) $CI->load->view('assists/debug_button');
